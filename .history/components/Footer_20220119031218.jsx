...
return (
	...
	<div className={styles.Container}>
		...
		<div className={styles.Column}>
			...
			<div className={styles.FooterLink} href="#">Blog</FooterLink>
			<div className={styles.FooterLink} href="#">Careers</FooterLink>
			<div className={styles.FooterLink} href="#">Advertise with us</FooterLink>
		</Column>
		<Column>
