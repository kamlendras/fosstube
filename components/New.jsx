...
focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-14 py-3 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
 ...
 Sign in with Twitter
      ...
      <hr class="hr1" />
        ...
        <div>
  <div id="g_id_onload" data-client_id="869063280256-8qn3m9bq5sj6koaqtvspt2g99oabteti.apps.googleusercontent.com" data-context="signin" data-ux_mode="popup" data-login_uri="http://localhost:3000/" data-auto_select="true" data-itp_support="true">
  </div>
  <div className="g_id_signin" data-type="standard" data-shape="pill" data-theme="outline" data-text="continue_with" data-size="large" data-logo_alignment="center">
  </div>
</div>
